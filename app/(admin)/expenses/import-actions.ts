...
const DEFAULT_RULES: Record<string, VendorRule> = {
  ...
  CLAUDE: { vendor: "Anthropic", category: "software", clientId: null },
  CURSOR: { vendor: "Cursor", category: "software", clientId: null },
  ANYSPHERE: { vendor: "Cursor", category: "software", clientId: null },
