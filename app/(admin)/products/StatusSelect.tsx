  ...
  return (
    <form action={setProductStatus}>
      ...
      <select
        ...
        className={`cursor-pointer rounded-full border-0 px-2.5 py-1 text-[11px] font-semibold outline-none focus:ring-2 focus:ring-tk-teal/40 ${productStatusClass(status)}`}
      >
        {STATUSES.map((value) => (
